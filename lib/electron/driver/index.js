...
Page.prototype.close = function (callback) {
  this.__engine__.withCallback('pageClose', { pageId: this.__id__ }, callback);
};


Page.prototype.set = function (key, value, callback) {
  this.__engine__.withCallback('pageSet', { key, value, pageId: this.__id__ }, callback);
};


Page.prototype.get = function (key, callback) {
  this.__engine__.withCallback('pageGet', { key, pageId: this.__id__ }, callback);
};


Page.prototype.openUrl = function (url, options, callback) {
  this.__engine__.withCallback('pageOpenUrl', { url, options, pageId: this.__id__ }, callback);
};
