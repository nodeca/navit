...
Page.prototype.invoke = function (/*command, params*/) {
...
Page.prototype.evaluate = function (/*fn , ...params*/) {
  return this.invoke.apply(this, [ 'evaluate' ].concat(slice(arguments)));
};
...
Engine.prototype.withCallback = function (pageId, method/*, ...args*/) {
  ...
  let message = {
    ...
    pageId,
    method,
    args: slice(arguments, 2).map(val => (_.isFunction(val) ? val.toString() : val))
  };
