...
Page.prototype.open = function (url, options, callback) {
  this.__engine__.withCallback('pageOpen', { url, options, pageId: this.__id__ }, callback);
};
...
Page.prototype.execFn = function (fn, args, callback) {
  this.__engine__.withCallback('execFn', { fn: fn.toString(), args, pageId: this.__id__ }, callback);
};

Page.prototype.execFnAsync = function (fn, args, callback) {
  this.__engine__.withCallback('execFnAsync', { fn: fn.toString(), args, pageId: this.__id__ }, callback);
};
