...
function open(url, options, callback) {
  ...
  async.series([
    ...
    // Get request headers
    next => this.__page__.get('customHeaders', (err, headers) => {
    ...
    next => this.__page__.set('customHeaders', _.assign({}, oldHeaders, options.headers), next),
    ...
    next => this.__page__.set('customHeaders', oldHeaders, next),
