...
functions.push([
  [ 'test.text' ],
  function test_text(selector, value, message, callback) {
...
functions.push([
  ...
  function test_not_text(selector, value, message, callback) {
    if (_.isFunction(message)) {
      callback = message;
      message = null;
    }
...
functions.push([
  [ 'test.count' ],
  function test_count(selector, value, message, callback) {
    if (_.isFunction(message)) {
      callback = message;
      message = null;
    }
    ...
    this.__queue__.push(function test_count_step(callback) {
      ...
      this.__page__.evaluate(function (selector) {
        ...
        check(function () {
          assert.strictEqual(count, _.isFunction(value) ? value() : value, message);
        }, callback);
      }, sel);
    });
...
functions.push([
  ...
  function test_not_count(selector, value, message, callback) {
    if (_.isFunction(message)) {
      callback = message;
      message = null;
    }
      ...
      this.__page__.evaluate(function (selector) {
        ...
        check(function () {
          assert.notStrictEqual(
            ...
            _.isFunction(message) ? message() : message
          );
        }, callback);
      }, sel);
    });
...
functions.push([
  [ 'test.evaluate' ],
  function test_evaluate(fn /*[, params..., message, callback]*/) {
    ...
    var callback = arguments.length > fn.length + 2 ? arguments[fn.length + 2] : null;
    ...
    this.__queue__.push(function test_evaluate_step(callback) {
      ...
      this.__page__.evaluate.apply(this.__page__, [ fn, function (err, result) {
        if (err) {
          callback(err);
          return;
        }
...
functions.push([
  [ 'test.title' ],
  function test_title(value, message, callback) {
    if (_.isFunction(message)) {
      callback = message;
      message = null;
    }
...
functions.push([
  ...
  function test_not_title(value, message, callback) {
    if (_.isFunction(message)) {
      callback = message;
      message = null;
    }
...
functions.push([
  [ 'test.url' ],
  function test_url(value, message, callback) {
    if (_.isFunction(message)) {
      callback = message;
      message = null;
    }
    ...
    this.__queue__.push(function test_url_step(callback) {
      ...
      this.__page__.get('url', function (err, title) {
        if (err) {
          callback(err);
          return;
        }
...
functions.push([
  ...
  function test_not_url(value, message, callback) {
    if (_.isFunction(message)) {
      callback = message;
      message = null;
    }
...
functions.push([
  [ 'test.attribute' ],
  function test_attribute(selector, attribute, value, message, callback) {
    if (_.isFunction(message)) {
      callback = message;
      message = null;
    }
...
functions.push([
  ...
  function test_not_attribute(selector, attribute, value, message, callback) {
    if (_.isFunction(message)) {
      callback = message;
      message = null;
    }
...
functions.push([
  [ 'test.exists' ],
  function test_exists(selector, message, callback) {
    if (_.isFunction(message)) {
      callback = message;
      message = null;
    }
...
functions.push([
  ...
  function test_not_exists(selector, message, callback) {
    if (_.isFunction(message)) {
      callback = message;
      message = null;
    }
...
functions.push([
  [ 'test.visible' ],
  function test_visible(selector, message, callback) {
    if (_.isFunction(message)) {
      callback = message;
      message = null;
    }
...
functions.push([
  ...
  function test_not_visible(selector, message, callback) {
    if (_.isFunction(message)) {
      callback = message;
      message = null;
    }
...
functions.push([
  [ 'test.status' ],
  function test_status(value, message, callback) {
    var self = this;
...
functions.push([
  ...
  function test_not_status(value, message, callback) {
    var self = this;
...
functions.push([
  [ 'test.header' ],
  function test_header(name, value, message, callback) {
    if (_.isFunction(message)) {
      callback = message;
      message = null;
    }
...
functions.push([
  ...
  function test_not_header(name, value, message, callback) {
    if (_.isFunction(message)) {
      callback = message;
      message = null;
    }
...
functions.push([
  [ 'test.body' ],
  function test_body(value, message, callback) {
    if (_.isFunction(message)) {
      callback = message;
      message = null;
    }
...
functions.push([
  ...
  function test_not_body(value, message, callback) {
    if (_.isFunction(message)) {
      callback = message;
      message = null;
    }
...
functions.push([
  [ 'test.not' ],
  function test_not(/*args...[, callback]*/) {
    // Status check
    if (_.isNumber(arguments[0])) {
